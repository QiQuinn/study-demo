...
public class IdCardVelidtor implements ConstraintValidator<IdCard,Object>
{
    ...
    {
        return checkResultMsg(IdCardUtils.checkIdCardPattern(idCard),"身份证格式错误！",context);
    }
    ...
    {
        return checkResultMsg(IdCardUtils.checkIdCardDate(date),"身份证出生年月日错误",context);
    }
    ...
    {
        return checkResultMsg(IdCardUtils.checkPowerCode(idCard),"身份证最后一位号码不对",context);
    }
    ...
    {
        return checkResultMsg(IdCardUtils.isVaildProvinceld(provinceId),"身份证省份码错误",context);
    }
