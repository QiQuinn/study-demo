...
insert into security_article (`title`,content,ishander,culomn_id,create_date,modify_date) value('热烈庆祝型中国成立70周年','习大大发表讲话:dsafasfsafsafasdfasfasfasfsafadsf十大发生发撒的肥肉我去饿饿哇
...
insert into security_article (`title`,content,ishander,culomn_id,create_date,modify_date) value('热烈庆祝型中国成立70周年','习大大发表讲话:dsafasfsafsafasdfasfasfasfsafadsf十大发生发撒的肥肉我去饿饿哇',1,3,'2019-03-04','2019-03-21');
insert into security_article (`title`,content,ishander,culomn_id,create_date,modify_date) value('关于XXX的通知','位于2019:热天耐热然而父亲的而且我发的',0,1,'2019-03-04','2019-03-21');
insert into security_article (`title`,content,ishander,culomn_id,create_date,modify_date) value('关于Xqy的通知','XQY is QiQiuinn:dsafasfsafsafasdfasfasfasfsafadsf十大发生发撒的肥肉我去饿饿哇',0,1,'2019-05-04','2019-05-21');
